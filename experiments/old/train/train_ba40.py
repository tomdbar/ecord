...
from ecord.graphs.generators import BarabasiAlbertGraphGenerator, EdgeType
...
if __name__ == "__main__":
    ...
    training_config = DQNTrainingConfig(
        # Episode
        graph_generator = BarabasiAlbertGraphGenerator([40, 40], (4,0.0), EdgeType.SIGNED),
        tradj_per_graph = 1,
