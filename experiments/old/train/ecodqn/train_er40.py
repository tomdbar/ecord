...
if __name__ == "__main__":
    ...
    network_config = NetworkConfig(
        ...
        glob_features=[
            GlobalObservation.SCORE_FROM_BEST_SCALE,
    ...
    training_config = DQNTrainingConfig(
        ...
        lr = 1e-4,
        gamma = 0.95,
        init_bce_weight=0., # Only matters if network_config.use_network_initialisation is True.
        ...
        initial_epsilon = 1.,
        final_epsilon = 0.05,
        final_epsilon_step = 6000,

        # Replay buffer.
        buffer_capacity = 20000,
        # k_BPTT = 5,
        n_step = 1,
        min_buffer_length = 5000,
    ...
    solver = DQNSolver(
        ...
        use_ecodqn=network_config.use_ecodqn,
    ...
    test_graph_configs = [
        ...
        TestGraphsConfig.from_file(
            label='ER200',
            graph_loc='_graphs_eco_dqn/validation/ER_200spin_p15_100graphs',
            num_load=10,
            **test_config_args,
        ),
        ]
