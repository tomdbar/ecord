...
if __name__ == "__main__":
    ...
    training_config = DQNTrainingConfig(
        # Episode
        graph_generator = ErdosRenyiGraphGenerator([200, 200], (0.12,0.0), EdgeType.CONSTANT),
        tradj_per_graph = 1,
    ...
    test_graph_configs = [
        TestGraphsConfig.from_file(
            label='ER500',
            graph_loc='_graphs/binary/ER_500spin_p05_100graphs',
            num_load=20,
            **test_config_args,
        ),
        TestGraphsConfig.from_file(
            label='ER2000_p01_bin',
            graph_loc='_graphs/binary/ER_2000spin_p01_10graphs',
            num_load=10,
            **test_config_args,
        ),
        ]
