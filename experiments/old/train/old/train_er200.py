...
if __name__ == "__main__":
    ...
    training_config = DQNTrainingConfig(
        # Episode
        graph_generator = ErdosRenyiGraphGenerator([200, 200], (0.15,0.0), EdgeType.SIGNED),
        tradj_per_graph = 1,
        ...
        lr = 5e-5,
        gamma = 0.7,
        init_bce_weight=1, # Only matters if network_config.use_network_initialisation is True.
