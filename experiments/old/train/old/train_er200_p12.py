...
if __name__ == "__main__":
    ...
    training_config = DQNTrainingConfig(
        # Episode
        graph_generator = ErdosRenyiGraphGenerator([200, 200], (0.12,0.0), EdgeType.SIGNED),
        tradj_per_graph = 1,
    ...
    test_graph_configs = [
        ...
        TestGraphsConfig.from_file(
            label='ER500_p05',
            graph_loc='_graphs/signed/ER_500spin_p05_100graphs',
            num_load=50,
            **test_config_args,
        ),
        TestGraphsConfig.from_file(
        ...
        # TestGraphsConfig.from_file(
        #     label='ER500_p15_bin',
        #     graph_loc='_graphs/binary/ER_500spin_p15_100graphs',
        #     num_load=50,
        #     **test_config_args,
        # ),
        # TestGraphsConfig.from_file(
