...
if __name__ == "__main__":
    ...
    network_config = NetworkConfig(
        ...
        return_dummy_hidden_state=True,
    )

    training_config = DQNTrainingConfig(
        # Episode
        graph_generator = ErdosRenyiGraphGenerator([40, 40], (0.15,0.0), EdgeType.SIGNED),
        tradj_per_graph = 1,
        ...
        lr = 1e-3,
        gamma = 0.7,
        init_bce_weight=0.1, # Only matters if network_config.use_network_initialisation is True.
        detach_gnn_from_rnn=True,
        ...
        k_BPTT = 3,
        n_step = 1,
        min_buffer_length = 2000,
        crop_tradjectories_at_final_reward = True,
    ...
    test_graph_configs = [
        TestGraphsConfig.from_file(
            label='ER40',
            graph_loc='_graphs_eco_dqn/testing/ER_40spin_p15_50graphs',
            num_load=50,
            **test_config_args,
        ),
        TestGraphsConfig.from_file(
            label='BA40',
            graph_loc='_graphs_eco_dqn/testing/BA_40spin_m4_50graphs',
            num_load=50,
            **test_config_args,
        ),
        TestGraphsConfig.from_file(
            label='ER500',
            graph_loc='_graphs_eco_dqn/testing/ER_500spin_p15_50graphs',
            num_load=50,
            **test_config_args,
        ),
        TestGraphsConfig.from_file(
            label='BA500',
            graph_loc='_graphs_eco_dqn/testing/BA_500spin_m4_50graphs',
            num_load=50,
            **test_config_args,
        ),
        ]
    ...
    test_graph_configs += [
        TestGraphsConfig.from_file(
            label='ER40',
            graph_loc='_graphs_eco_dqn/validation/ER_40spin_p15_100graphs',
            num_load=100,
            **test_config_args,
        ),
        TestGraphsConfig.from_file(
            label='ER500',
            graph_loc='_graphs_eco_dqn/validation/ER_500spin_p15_100graphs',
            num_load=100,
            **test_config_args,
        ),
    ]
