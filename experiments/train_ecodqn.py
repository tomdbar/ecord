...
from ecord.environment import NodeObservation, GlobalObservation
...
from ecord.train import Trainer
...
if __name__ == "__main__":
    ...
    test_graph_configs = [
        TestGraphsConfig.from_file(
            label='ER40',
            graph_loc='graphs/ecodqn/testing/ER_40spin_p15_50graphs',
            num_load=50,
            **test_config_args,
        ),
        TestGraphsConfig.from_file(
            label='ER200',
            graph_loc='graphs/ecodqn/testing/ER_500spin_p15_50graphs',
            num_load=10,
            **test_config_args,
        ),
        ]
